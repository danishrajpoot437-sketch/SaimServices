...
export default function ContentPowerhouse() {
  ...
  return (
    <section id="content-powerhouse" className="py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Ambient glow */}
      <div className="absolute -left-48 bottom-1/4 w-[400px] h-[400px] rounded-full pointer-events-none"
        ...
        >
          <div className="flex items-center gap-4 mb-5">
            <motion.div
              ...
              className="w-11 h-11 rounded-xl bg-amber-500/20 flex items-center justify-center glow-gold"
            >
          ...
          <div className="w-48 h-px mt-6 ml-[60px] rounded-full"
            style={{ background: "linear-gradient(90deg, rgba(251,191,36,0.5), rgba(245,158,11,0.2), transparent)" }}
          />
        </motion.div>
            ...
            >
              {activeTool === tool.id && (
                <motion.div
                  ...
                  style={{
                    background: "linear-gradient(135deg, rgba(251,191,36,0.14) 0%, rgba(245,158,11,0.06) 100%)",
                  }}
              ...
              <div className={`relative w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-200 ${
                ...
                <tool.icon className={`w-4 h-4 transition-colors duration-200 ${activeTool === tool.id ? "text-amber-400" : "text-muted-foreground"}`} />
              </div>
